                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about__image">
                            <img src="{{$about_data->about_image}}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about__content">
                            <div class="section__title">
                                ...
                                <h2 class="title">{{$about_data->title}}</h2>
                            </div>
                            <div class="about__exp">
                                ...
                                <div class="about__exp__content">
                                    <p><span>{{$about_data->short_title}}</p>
                                </div>
                            </div>
                            <p class="desc">{{$about_data->short_description}}</p>
