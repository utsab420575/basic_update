<section class="portfolio">
    ...
    @php
    $portfolio_data=\App\Models\Portfolio::latest()->get();
    @endphp
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col">
                        <div class="portfolio__active">
                            ...
                            @foreach($portfolio_data as $single_portfolio_data)
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset($single_portfolio_data->portfolio_image)}}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>{{$single_portfolio_data->portfolio_name}}</span>
                                        <h4 class="title"><a href="portfolio-details.html">{{$single_portfolio_data->portfolio_title}}</a></h4>
